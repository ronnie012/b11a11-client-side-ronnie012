...
const PackageManagementItem = ({ pkg, onDelete, isDeleting }) => {
  ...
  return (
    <div className="card lg:card-side w-full bg-base-200 shadow-xl mb-8 rounded-2xl hover:shadow-2xl hover:scale-108 ring-2 ring-green-500 hover:ring-4 hover:ring-green-500 hover:bg-orange-400  transition-all duration-1 ease-in-out hover:cursor-pointer">
