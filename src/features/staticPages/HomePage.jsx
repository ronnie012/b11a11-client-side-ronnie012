          ...
          {!packagesLoading && !packagesError && featuredPackages && featuredPackages.length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
              {featuredPackages.map(pkg => (
                <div key={pkg._id} className="card bg-base-200 shadow-xl hover:shadow-2xl hover:scale-102 ring-1 ring-green-400 hover:ring-2 hover:ring-green-500 hover:bg-orange- transition-all duration-1 ease-in-out hover:cursor-pointer">
