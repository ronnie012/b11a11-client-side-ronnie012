          ...
          {!packagesLoading && !packagesError && featuredPackages && featuredPackages.length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
              {featuredPackages.map(pkg => (
                <div key={pkg._id} className="card bg-base-200 shadow-xl hover:shadow-2xl hover:scale-102 ring-1 ring-green-400 hover:ring-1 hover:ring-orange-500 hover:bg-orange- transition-all duration-1 ease-in-out hover:cursor-pointer">
        ...
        <div className="w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map(testimonial => (
              <div key={testimonial.id} className="card bg-base-200 shadow-xl p-6 flex flex-col items-center text-center hover:scale-102 transition-all duration-1 ease-in-out  hover:shadow-2xl ring-1 ring-success hover:ring-1 hover:ring-orange-500  hover:cursor-pointer">
